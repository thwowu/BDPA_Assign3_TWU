...
Note: Taking the whole complete file to run the similarity test took several hours to compile one run. In order to effectively present the result of this assignment, the document is reduced to the first 2000 lines as the input argument.
